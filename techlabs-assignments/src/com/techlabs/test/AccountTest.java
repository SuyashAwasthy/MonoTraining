...
public class AccountTest {
	...
	public static void main(String[] args) {
		...
		SavingsAccount savingsAccount = new SavingsAccount(1, "Shivansh",2000, 1000);
		CurrentAccount currentAccount = new CurrentAccount(1, "Suyash", 1000, 100);
		...
		private static void handleOperation(int accountType, Scanner scanner, Account account) {
			...
			while(!exitOperation) {
				...
				case 2:
					...
					break;
				case 3:
					System.out.println("You Selected Credit into account");
					creditAccount(accountType,account, scanner);
			
					break;
				case 4:
					System.out.println("You Selected Debit from account");
