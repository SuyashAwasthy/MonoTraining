        ...
        while (!exit){
            ...
            switch (choose){
                case 1 :
                    ...
                    account= AccountFactory.getAccount(accountNumber,accountName,accountBalance);
                ...
                case 2:
                    ...
                    account= AccountFactory.getAccount(accountNumber,accountBalance,overdraftLimit);
                    System.out.println("Account created");
                    break;
